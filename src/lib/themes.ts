 ...
 */
export const themeData: Record<Theme, { name: string; icon: string; cards: { pairId: string; emoji: string; image?: string }[] }> = {
	dinosaur: {
		name: 'Dinosaurs',
		icon: '🦕',
		cards: [
			{ pairId: 'dino-trex', emoji: '🦖', image: '/images/dinosaur/dino-trex.png' },
			{ pairId: 'dino-bronto', emoji: '🦕', image: '/images/dinosaur/dino-bronto.png' },
			{ pairId: 'dino-egg', emoji: '🥚', image: '/images/dinosaur/dino-egg.png' },
			{ pairId: 'dino-leaf', emoji: '🌿', image: '/images/dinosaur/dino-leaf.png' },
			{ pairId: 'dino-volcano', emoji: '🌋', image: '/images/dinosaur/dino-volcano.png' },
			{ pairId: 'dino-bone', emoji: '🦴', image: '/images/dinosaur/dino-bone.png' },
			{ pairId: 'dino-footprint', emoji: '🦶', image: '/images/dinosaur/dino-footprint.png' },
			{ pairId: 'dino-fossil', emoji: '🪨', image: '/images/dinosaur/dino-fossil.png' },
			{ pairId: 'dino-fern', emoji: '☘️', image: '/images/dinosaur/dino-fern.png' },
			{ pairId: 'dino-palm', emoji: '🌴', image: '/images/dinosaur/dino-palm.png' },
			{ pairId: 'dino-lizard', emoji: '🦎', image: '/images/dinosaur/dino-lizard.png' },
			{ pairId: 'dino-croc', emoji: '🐊', image: '/images/dinosaur/dino-croc.png' },
			{ pairId: 'dino-turtle', emoji: '🐢', image: '/images/dinosaur/dino-turtle.png' },
			{ pairId: 'dino-snake', emoji: '🐍', image: '/images/dinosaur/dino-snake.png' },
			{ pairId: 'dino-dragon', emoji: '🐉', image: '/images/dinosaur/dino-dragon.png' },
			{ pairId: 'dino-mushroom', emoji: '🍄', image: '/images/dinosaur/dino-mushroom.png' },
...
export function getImageForCard(theme: Theme, pairId: string): string | undefined {
	const cards = themeData[theme].cards;
	const card = cards.find((c) => c.pairId === pairId);
	return card?.image;
}
